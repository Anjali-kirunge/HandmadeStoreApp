...
export default function ProductForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Keep Redux cache fresh across the app
      ...
      if (msg.includes('conflicts with existing records')) {
        setError('A product with this SKU already exists. Please change the SKU or leave it blank to auto-generate a unique one.');
      } else {
        setError(msg);
      }
    } finally {
  ...
  return (
    <div>
      ...
      <div className="premium-card animate-slide-down" style={{ maxWidth: 760 }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <p className="form-hint" style={{ marginTop: '4px' }}>Leave blank to auto-generate</p>
              </div>
              <div className="form-group">
