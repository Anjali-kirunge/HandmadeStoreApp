...
const EditProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      existingImages.forEach((img) => {
        formData.append('existingImages', typeof img === 'string' ? img : img.url || img);
      });
    ...
    return (
      <Container fluid>
        <div className="text-center py-5">
          ...
          <Button variant="warning" onClick={() => navigate('/seller/products')}>
            Back to Products
          </Button>
        </div>
      </Container>
  ...
  return (
    <Container fluid>
      <Helmet>
        <title>Edit Product - Handmade Store</title>
      </Helmet>

      <div className="mb-4">
        <h4 className="fw-bold">Edit Product</h4>
        <p className="text-muted mb-0">Update the product details below</p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <Row className="g-4">
          ...
          <Col lg={4}>
            ...
            <Card className="border-0 shadow-sm mb-4">
              <Card.Body>
                <h6 className="fw-bold mb-3">Existing Images</h6>
